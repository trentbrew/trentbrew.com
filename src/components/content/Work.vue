			...
			return {
				...
				projects: [
					...
					},
					{
						...
						category: 'Games',
						content: {
							embed: 'https://trentbrew.pockethost.io/api/files/swvnum16u65or8w/b4rp2t947h5p4z8/qr79D4c80BeK_FA6d8n9gcU.png?token=',
						},
						dims: '420x420',
					},
					// ----------------- DESIGN -----------------
	...
	<div class="app">
      ...
      <div class="item-left">
        ...
        Apps
						...
						<div class="side-menu">
							<a :class="category == 'Web' && 'category-active'" @click="updateCategory('Web')" href="#">
								<div class="item-left">
        ...
        Resume
			...
			<div class="main-container">
				<div class="content-wrapper">
					<div class="content-section" :style="(category == 'Illustration' || category == 'Resume') && 'display: block !important'">
						<Card v-for="(project, index) in projects" :key="index" :activeCategory="category" :project="project" transition="expand" />
