    ...
    methods: {
        updateCategory(category) {
            ...
            /*if (category == 'Apps') {
                ...
                this.categoryCaption = "Web design and development is constantly changing and evolving, which means there's always something new to learn. It can be challenging, rewarding, and a great way to bring static designs and ideas to life."
            } else if (category == 'Games') {
                this.categoryCaption = "Making games has been the catalyst for my love of developing all kinds of interactive experiences. I started creating games in junior high with GameMaker, and I’ve been hooked ever since. Sonic GX was the first game I published, and I fondly remember dreaming up level designs and characters with my brother and sister.";
