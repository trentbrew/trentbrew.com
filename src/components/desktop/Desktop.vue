    ...
    return {
      ...
      dockItems: [
        ...
        // },
        {
          ...
          embed:
            "https://open.spotify.com/embed-legacy/album/07bQPrG1jSRCkd9SvBXsy4?si=TMkS9EXFRHSood1uznALAg?utm_source=generator",
        },
        // {
        //   icon: 'about.svg',
        //   label: 'About',
  ...
  >
    ...
    <Dock :hide="fullscreen">
      <div
        ...
        :key="index"
        :style="index === dividerIndex && 'margin-left: 28px;'"
        class="dock-item"
        @click="
          item.link
