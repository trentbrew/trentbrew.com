		...
		<div>
			...
			<div class="root" :style="clickActive && 'transform: scale(0.95)'">
				...
				<div
					...
					:style="`${clicked ? 'background: black' : hovering ? 'background: #BCC3C9 !important' : 'background: #CFD5DB !important'};`">
					<div
								...
								<div class="lid">
									...
									<div class="side bottom">
										<div class="screen" :style="`${popup && 'display: none;'}`">
											<img
												:src="`${
													boot ? require('@/assets/intro/boot.gif') : preboot ? require('@/assets/intro/static.gif') : require('@/assets/intro/glitch1.gif')
												}`"
												width="100%"
												height="100%" />
...
<style lang="scss" scoped>
	...
	.laptop .base .side.top:before {
		...
		background-image: repeating-linear-gradient(0deg, transparent 0, transparent 0.8em, $keyboard_frame_color 0.9em, $keyboard_frame_color 1em),
			repeating-linear-gradient(90deg, transparent 0, transparent 0.9em, $keyboard_frame_color 0.9em, $keyboard_frame_color 1.1em);
	}
