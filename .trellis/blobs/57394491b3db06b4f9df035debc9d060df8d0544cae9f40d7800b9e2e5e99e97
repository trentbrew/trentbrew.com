      ...
      return {
        ...
        projects: [
          // ----------------- WEB -----------------
          {
            ...
            thumb: require('@/content/UX/filegraph/filegraph.gif'),
            content: {
              link: 'https://github.com/trentbrew/filegraph-desktop/releases/tag/app-v1.0.2',
            },
            newtab: true,
          },
          {
            title: 'GSAP Studio',
            category: 'Web',
            description: 'AI-powered motion design instrument',
...
<style lang="scss" scoped>
  ...
  :root {
    ...
    --body-font: 'BerkleyMono', 'Courier New', monospace;
